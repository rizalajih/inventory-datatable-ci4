        ...
        <div class="card-body">
            <form method="post" action="<?= base_url('barang/update');?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?= $barang->nama_vendor;?>" name="vendor" required class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Merk</label>
                    <input type="text" value="<?= $barang->merk;?>" name="merk" required class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Telepon</label>
                    <input type="number" value="<?= $barang->telepon;?>" name="telepon" required class="form-control">
                </div>
                <div class="form-group">
